...
class LayeringFraudGenerator:
    ...
    def generate_and_ingest_threaded(self, total_events: int, num_workers: int) -> dict:
        ...
        logger.info(f"ðŸš€ Starting layering fraud generation with Austin, TX configuration:")
...
def main():
    ...
    print(f"ðŸ“Š Index: fraud-workshop-layering")
    ...
    if not generator.ingester.test_connection():
        ...
        print("\nðŸš€ Generating layering fraud data to files only...")
    ...
    print(f"\nðŸš€ Starting layering fraud data generation...")
    start_time = time.time()
    ...
    # Display results
    print(f"\n" + "=" * 60)
    print("ðŸ“Š LAYERING FRAUD WORKSHOP COMPLETE")
    print("=" * 60)
    ...
    print(f"\nðŸ•µï¸ Start detecting layering fraud in index '{es_config.index_name}'!")
