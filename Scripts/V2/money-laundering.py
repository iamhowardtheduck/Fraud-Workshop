...
Run from: /home/elastic/Fraud-Workshop
Your Elasticsearch: https://es.elastic.lab:443
...
class ElasticsearchConfig:
    ...
    host: str = "https://es.elastic.lab:443"
...
def main():
    ...
    print(f"ðŸ” Elasticsearch: https://es.elastic.lab:443")
